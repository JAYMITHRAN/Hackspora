    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 cursor-gaming">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {statCards.map(({ id, label, value, accent, border, Icon, iconColor }) => (
            <div
              key={id}
              className={cn(
                "bg-white rounded-xl p-6 shadow-lg transition-all duration-300 border hover:shadow-xl hover:-translate-y-1",
                border,
              )}
            >
              ...
              {sections.map((section) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "group relative p-6 rounded-xl transition-all duration-300 ease-in-out cursor-pointer border",
                  ...
                  >
                    ...
                    {/* Hover glow effect */}
                    <div className={cn(
                      "absolute inset-0 rounded-xl opacity-0 transition-opacity duration-300 pointer-events-none border-2 border-transparent",
                      activeSection === section.id
                        ? "opacity-100 border-white/30"
                        : "group-hover:opacity-100 group-hover:border-blue-200"
                    )} />
                  </button>
                )
              })}
